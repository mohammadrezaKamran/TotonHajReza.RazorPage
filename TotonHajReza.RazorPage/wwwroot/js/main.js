/*==============================
    ...
    setInterval(function time(){
      ...
      jQuery('.timer-section1 ul').html('<li class="clock-li"><span class="clock-timer">'+sec+
        '</span><span class="clock-title">ثانیه</span></li><li class="clock-li"><span class="clock-timer">'+min+
        '</span><span class="clock-title">دقیقه</span></li><li class="clock-li"><span class="clock-timer">'+hours+
        '</span><span class="clock-title">ساعت</span></li><li class="clock-li"><span class="clock-timer">'+days+
        '</span><span class="clock-title">روز</span></li>')
    }, 1000);   
    ...
    jQuery(document).ready(function() {
        ...
        $('#home-slider .owl-dot')[0].innerHTML = '<div class="inner"></div><div class="bar right-bar"><div class="progress-wrap"></div></div><div class="bar left-bar"><div class="progress-wrap"></div></div>';
        owl.owlCarousel();
        owl.on('changed.owl.carousel', function() {
            ...
            for(var button of buttons) {
                if(button.classList.contains('active')) {
                    button.innerHTML = '<div class="inner"></div><div class="bar right-bar"><div class="progress-wrap"></div></div><div class="bar left-bar"><div class="progress-wrap"></div></div>';
                } else {
